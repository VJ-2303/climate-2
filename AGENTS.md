...
cooling 0.35/0.30/0.20/0.15 · WBGT tiers 30/34/38/41 (Critical > 38.0) · anomaly factor 0.4 ·
settlement mean 49.5 · tier-bump threshold 70 · risk-score zero point 28.0 ·
HVI risk tiers: Low <= 45, Medium 46-70, High 71-85, Critical > 85.

---

## Inputs — `data/processed/`

9 rasters, identical CRS (32643), 20m pixels, shape, transform — assert at every stage start.

| File | Valid range |
|---|---|
| `ndvi.tif`, `ndwi.tif`, `ndbi.tif` | [-1, 1] |
| `landsat_st_celsius.tif` | [10, 65] |
...
| `madurai_boundary.geojson` | EPSG:32643 single polygon |
...
|---|---|---|
| `data/processed/madurai_blocks_50m.geojson` | 01, updated by 06 | 02, 04, 06, 07 |
...
| `models/graph_train.pt` / `graph_madurai.pt` | 04 | 05 / 06 |
